...
--https://www.sqlzoo.net/wiki/The_nobel_table_can_be_used_to_practice_more_SUM_and_COUNT_functions.
...
-- Be aware that Frederick Sanger has won the chemistry prize twice - he should only be counted once.
...
SELECT yr FROM nobel
  WHERE subject = 'Physics'
  GROUP BY yr HAVING COUNT(subject) = 3;

--10. Show winners who have won more than once.
SELECT winner FROM nobel
  GROUP BY winner HAVING count(*) > 1;
